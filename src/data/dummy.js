...
export const EditorData = () => (
  <div>
    <h3>
      Welcome to CyberSentinal
      CyberSentinal is your one-stop solution for monitoring vulnerabilities in OEM software, hardware, and firmware.
      Our advanced web-scraping tool ensures that every vulnerability is detected and stored in a secure database for easy access and review.

      Vulnerability Database
      Each vulnerability is tracked with a detailed historical record that includes:
      - Vulnerability description
      - Severity level (Critical, High, Moderate)
      - Affected product or service
      - Links to official advisories or patches
      - Date of discovery or reporting

      Data Security
      CyberSentinal uses advanced encryption techniques to ensure that your vulnerability reports and product information are safely stored. Unauthorized access is prevented by a robust security architecture.

      Automated Alerts and Notifications
      Our platform provides real-time automated alerts for any new vulnerabilities discovered, along with email alerts that include:
      - Detailed description of the vulnerability
      - Severity rating and recommended actions
      - Links to patches and advisories

      Customizable Reports
      You can generate detailed reports with insights into the vulnerabilities affecting your products. These reports are ideal for internal security reviews or to be shared with your management team for strategic decision-making.

      Long-term Risk Mitigation
      As technology evolves, so does CyberSentinal. Our platform is designed to adapt and grow with emerging technologies, ensuring long-term risk mitigation for your organization.
    </h3>
  </div>
);
